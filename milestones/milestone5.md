...
👉🏾👉🏾👉🏾 We faced some difficulties with integrating the frontend and backend, particularly with handling database relationships and ensuring data consistency. Debugging these issues took more time than anticipated.

### 3. What were some of the highlights or achievements that you are most proud of in this project?

👉🏾👉🏾👉🏾 We are particularly proud of implementing a well-designed RESTful API and dynamic frontend routes. Additionally, the custom features like error handling and data validation added robustness to our project.

### 4. Reflecting on your web development journey so far, how have you grown since the beginning of the course?

👉🏾👉🏾👉🏾 Since the beginning of the course, we have gained a deeper understanding of full-stack development, particularly in managing state in React and designing RESTful APIs. My problem-solving skills have also improved significantly.

### 5. Looking ahead, what are your goals related to web development, and what steps do you plan to take to achieve them?

👉🏾👉🏾👉🏾 My goals include mastering advanced React concepts and backend development with Node.js. we plan to achieve this by working on more complex projects, contributing to open-source, and continuously learning through online courses and tutorials.
